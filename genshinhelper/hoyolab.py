...
class HKStarRail(Client):
    def __init__(self, cookie: str = None):
        ...
        self.uid = self.cookie['account_id']
        log.debug(self.cookie['account_id'])
        # return
        self.headers = get_headers(oversea=True)
        ...
        # 本日签到信息
        self.sign_info_url = f'{self.api}/event/luna/os/info?lang={self.lang}&act_id={self.act_id}'
        # resign info
        self.resign_info_url = f'{self.api}/event/luna/os/resign_info?lang={self.lang}&act_id={self.act_id}'
        # 本月活动信息
        self.rewards_info_url = f'{self.api}/event/luna/os/home?lang={self.lang}&act_id={self.act_id}'
        # 签到提交url
        self.sign_url = f'{self.api}/event/luna/os/sign?lang={self.lang}'
